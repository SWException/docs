...
\begin{center}
	...
	\begin{longtable}{|p{1cm}|p{4.85cm}|p{9cm}|}
		...
		\valueCTS & Verifica logout cliente & Verificare che il cliente autenticato possa effettuare il logout e che venga riportato alla home page \\
		...
		\valueCTS & Verifica logout venditore & Verificare che il venditore possa effettuare il logout \\
