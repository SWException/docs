...
I test di sistema devono assicurare il soddisfacimento dei requisiti individuati nel documento \dext{AnalisiDeiRequisiti\_4.0.0}.
...
\begin{center}
	...
	\begin{longtable}{|p{0.85cm}|p{2.25cm}|p{9cm}|p{3cm}|}
		...
		\valueCTS & Visualizzazione informazioni venditore & Verificare che un utente generico possa visualizzare la pagina contenente le informazioni relative al venditore che includono la ragione sociale e i contatti. & Superato \\
		...
		\valueCTS & Verifica contatto venditore & Verificare che il cliente possa contattare il venditore tramite l'apposito form  & Superato\\
...
La seguente tabella riporta l'associazione dei test precedentemente descritti con i requisiti presenti nel documento \dext{AnalisiDeiRequisiti\_4.0.0}. Si precisa che ogni test comprende anche eventuali sotto requisiti.
\resetCTS
\begin{center}
	\rowcolors{1}{white}{blue!20}
	\begin{longtable}{|c|c|}
