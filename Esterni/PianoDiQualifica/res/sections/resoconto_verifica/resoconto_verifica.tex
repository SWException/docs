...
\begin{center}
    \begin{figure}[!htb]
        \centering
        \includegraphics[scale=0.60]{res/images/RQgulpease.png}
        \caption{Grafico Indice di Gulpease}
    \end{figure}
    \begin{center}
        \rowcolors{2}{white}{blue!20}
...
\begin{center}
    ...
    \begin{figure}[!htb]
        ...
        che rispettano quanto previsto nelle \dext{NormeDiProgetto\_2.0.0}, ovvero quando la lunghezza massima delle righe è pari a 100 
    ...
    \begin{figure}[!htb]
        ...
        grafico il dato minimo desiderabile previsto dalle \dext{NormeDiProgetto\_2.0.0} è superiore ad 80
...
Di seguito sono presentanti i dati relativi ai requisiti obblgiatori soddisfatti è trascurabile una rappresentazione grafica dei requisti obbigligatori di 
