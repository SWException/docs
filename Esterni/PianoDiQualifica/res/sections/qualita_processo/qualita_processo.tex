...
\paragraph{Percentuale requisiti obbligatori soddisfatti}
 ...
 \begin{itemize}
    ...
    \item \textbf{Formula:}
                  ...
                  \[\textit{PROS} =\frac{\textit{requisiti obbligatori soddisfatti}}{\textit{requisiti obbligatori individuati}}*100\]

    \item \textbf{Range di valori che può assumere:}
    \begin{itemize}
        \item Accettabile: \textit{PROS} = 100\%
        \item Ottimale: \textit{PROS}  = 100\%
    \end{itemize}
\end{itemize}
