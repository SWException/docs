...
\subsection{Scopo}
Al fine di rispettare quanto preventivato nel \dext{PianoDiProgetto\_3.0.0} e per perseguire gli obiettivi di qualità è necessario operare con un ciclo di vita che determina quali processi
...
\begin{itemize}
    \item \textbf{Rispetto della pianificazione:} ci si pone l'obiettivo di rispettare quanto pianificato all'interno del \dext{PianoDiProgetto\_3.0.0}
...
Questo processo tiene conto di tutte le attività di analisi intraprese nel corso dello sviluppo del prodotto ovvero in primis il documento di \dext{AnalisiDeiRequisiti\_3.0.0}
...
gli strumenti utilizzati nonché le variazioni attuate nel corso del progetto. Si deve tener conto di quanto previsto nel documento delle \dext{NormeDiProgetto\_3.0.0} per quanto
