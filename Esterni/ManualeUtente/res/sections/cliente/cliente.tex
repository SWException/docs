...
After accessing the the application by link you will land to the homepage.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=25em]{res/images/cliente/refinementtools.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=5em]{res/images/cliente/profileaccount.png}
...
To manage your orders you have to go to the page \href{https://d28yg0rufs9lo7.cloudfront.net/orders}{orders} or click on the button of the profile and select "My orders".
\begin{figure}[H]
    \centering
    \includegraphics[width=5em]{res/images/cliente/profileorder.png}
...
To contact the seller you can find the link of the e-mail in the footer of the homepage. You can reach the page just clicking \href{https://d28yg0rufs9lo7.cloudfront.net/}{here}.
