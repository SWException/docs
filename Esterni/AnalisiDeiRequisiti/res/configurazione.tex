...
\newcounter{CSSSUC} % Contatore Sotto-Sotto-Sotto-UserCases
\newcommand{\stepUserCase}[0]{\stepcounter{CUC}\setcounter{CSUC}{0}\setcounter{CSSUC}{0}\setcounter{CSSSUC}{0}} % incrementa il contatore CUC
\newcommand{\stepsubUserCase}[0]{\stepcounter{CSUC}\setcounter{CSSUC}{0}\setcounter{CSSSUC}{0}} % incrementa il contatore CSUC
\newcommand{\stepsubsubUserCase}[0]{\stepcounter{CSSUC}\setcounter{CSSSUC}{0}} % incrementa il contatore CSSUC
\newcommand{\stepsubsubsubUserCase}[0]{\stepcounter{CSSSUC}} % incrementa il contatore CSSSUC
...
\newcommand{\valuesubsubsubUserCase}[0]{UC\arabic{CUC}.\arabic{CSUC}.\arabic{CSSUC}.\arabic{CSSSUC} } % ritorna il valore del contatore CSSSUC
...
\newcommand{\valuesubsubsubUC}[0]{UC\arabic{CUC}.\arabic{CSUC}.\arabic{CSSUC}.\arabic{CSSSUC}} % ritorna il valore del contatore CSSSUC senza spazio finale
\newcommand{\resetCUC}[0]{\setcounter{CUC}{0}\setcounter{CSUC}{0}\setcounter{CSSUC}{0}\setcounter{CSSSUC}{0}}  % resetta il contatore CUC, CSUC, CSSUC e CSSSUC
...
\newcommand{\labelsubsubsubUserCase}[0]{\label{UC\arabic{CUC}.\arabic{CSUC}.\arabic{CSSUC}.\arabic{CSSSUC}}}
