\subsection{UC15 - Form di contatto venditore}
\label{UC15}
\begin{itemize}
...
\subsubsection{UC17.1 - Modifica stato ordine}
\label{UC17.1}
\begin{itemize}
    \item \textbf{Attore Primario:} venditore autenticato;
...
\subsubsection{UC17.3 - Visualizzazione dettagli ordine}
\label{UC17.3}
\begin{itemize}
    \item \textbf{Attore Primario:} venditore autenticato;
...
\subsection{UC19 - Amministrazione tasse}
\label{UC19}
\begin{itemize}
    \item \textbf{Attore Primario:} venditore autenticato
...
\subsubsection{UC19.2 - Modifica aliquota IVA}
\label{UC19.2}
\begin{itemize}
    \item \textbf{Attore Primario:}  venditore autenticato
...
\subsection{UC20 - Amministrazione prodotti}
\label{UC20}
\begin{itemize}
    \item \textbf{Attore Primario:}  venditore autenticato
...
\subsubsection{UC20.1 - Aggiunta prodotto}
\label{UC20.1}
\begin{itemize}
    \item \textbf{Attore Primario:}  venditore autenticato.
...
\subsubsection{UC20.2 - Modifica  prodotto}
\label{UC20.2}
\begin{itemize}
    \item \textbf{Attore Primario:}  venditore autenticato.
...
\subsubsection{UC20.3 - Rimozione prodotto}
\label{UC20.3}
\begin{itemize}
    \item \textbf{Attore Primario:}  venditore autenticato.
...
\subsection{UC21 - Amministrazione categorie}
\label{UC21}
\begin{itemize}
    \item \textbf{Attore Primario:}  venditore autenticato.
...
\subsubsection{UC21.1 - Aggiungi categoria}
\label{UC21.1}
\begin{itemize}
    \item \textbf{Attore Primario:}  venditore autenticato.
...
\subsubsection{UC21.2 - Modifica categoria}
\label{UC21.2}
\begin{itemize}
    \item \textbf{Attore Primario:}  venditore autenticato.
...
\subsection{UC22 - Logout venditore}
\label{UC22}
\begin{itemize}
    \item \textbf{Attore Primario:} venditore autenticato;
...
\subsection{UC24 - Login venditore}
\label{UC24}
\begin{itemize}
