...
\begin{itemize}
    ...
    \begin{enumerate}
        ...
        \item il venditore può contattare il cliente che ha effettuato un determinato ordine \hyperref[UC17]{UC17};
...
\begin{itemize}
    ...
    \begin{enumerate}
        \item il venditore visualizza la lista;
         \item il venditore può contattare un cliente \hyperref[UC17]{UC17};
    \end{enumerate}
\end{itemize}

\subsection{UC17 - Contatta cliente}
\label{UC17}
\begin{itemize}
    \item \textbf{Attore Primario:} venditore autenticato;
    \item \textbf{Descrizione:} il venditore deve contattare il cliente;
...
\subsection{UC18 - Amministrazione tasse}
\begin{itemize}
...
\subsection{UC19 - Amministrazione prodotti}
\begin{itemize}
    \item \textbf{Attore Primario:} 
    \item \textbf{Descrizione:}
    \item \textbf{Precondizione:}
...
\subsection{UC20 - Amministrazione categorie}
\begin{itemize}
    \item \textbf{Attore Primario:} 
    \item \textbf{Descrizione:}
    \item \textbf{Precondizione:}
    ...
    \end{itemize}
\end{itemize}
\subsection{UC21 - Logout venditore}
\begin{itemize}
    \item \textbf{Attore Primario:} 
    \item \textbf{Descrizione:}
    \item \textbf{Precondizione:}
    ...
    \end{itemize}
\end{itemize}
\subsection{UC22 - Login venditore}
\begin{itemize}
    \item \textbf{Attore Primario:} 
    \item \textbf{Descrizione:}
    \item \textbf{Precondizione:}
