...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:}
          \begin{enumerate}
              ...
              \item il cliente può ordinare i prodotti per prezzo  (\hyperref[UC4.2]{UC4.2}).
          \end{enumerate}
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:}
          \begin{enumerate}
              ...
              \item il venditore può ricercare un cliente tramite la sua email (\hyperref[UC18.1]{UC18.1}).
          \end{enumerate}
\end{itemize}

%18.1
\stepsubUserCase
\subsubsection{\valuesubUserCase- Ricerca cliente tramite email}
\labelsubUserCase
\begin{itemize}
    \item \textbf{Attore primario:} venditore autenticato;
