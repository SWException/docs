...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:}
          \begin{enumerate}
              ...
              \item il cliente può applicare ulteriori filtri (\hyperref[UC5]{UC5});
              \item il cliente può ordinare i prodotti per prezzo  (\hyperref[UC6]{UC6}).
          \end{enumerate}
...
%19.5
\stepsubUserCase
\subsection{\valuesubUserCase - Lista ordini}
\labelsubUserCase
\begin{itemize}
    \item \textbf{Attore primario:} venditore autenticato;
...
\begin{itemize}
    ...
    \item \textbf{Scenario principale:} il venditore ha cliccato sul pulsante di visualizzazione categorie disponibile nella pagina di gestione categorie;
