...
\begin{center}
    ...
    \begin{longtable}{|p{3cm}|p{9.85cm}|p{2cm}|}
        ...
        \sreq{1}{F} & L'utente può selezionare l'indirizzo di consegna e fatturazione da quelli salvati & \refUserCase{UC8.1}\refUserCase{UC8.2} \row
        ...
        \sreq{1}{F} & Il cliente deve poter compilare il form per contattare il venditore & \refUserCase{UC13.1} \refUserCase{UC13.2} \refUserCase{UC13.3} \row
