...
\begin{center}
    ...
    \begin{longtable}{|p{2.5cm}|p{10.35cm}|p{2cm}|}
        ...
        %R1F30.2
        \sreq{1}{F} & Il sistema deve fare il display dell'errore se le email inserite non sono corrette & \refUserCase{UC18.1}\row
        ...
        %R1F30.5
        \sreq{1}{F} & Il sistema deve fare il display dell'errore se le password inserite non sono corrette & \refUserCase{UC18.2}\row
        ...
        %R1F34.1
        \sreq{1}{F} & Il venditore deve visualizzare un messaggio se id& \refUserCase{UC37}\row
        ...
        %R2F37.1
        \sreq{2}{F} & Il venditore deve visualizzare un messagio se non viene trovato nessun cliente & \refUserCase{UC26}  \row
        ...
        %R2F39.1
        \sreq{2}{F} & Il venditore deve poter visualizzare un messagio se non viene trovato nessun prodotto & \refUserCase{UC35}  \row
        
        %R2F40
        \req{2}{F} & Il venditore deve poter filtrare la lista di prodotti del negozio & \refUserCase{UC36}  \row

        %R2F40.1
        \sreq{2}{F} & Il venditore deve poter visualizzare un messagio se non viene trovato nessun prodotto & \refUserCase{UC36}  \row
