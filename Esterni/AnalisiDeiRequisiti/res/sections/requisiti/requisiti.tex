...
In seguito viene riportato, organizzato in forma tabellare, l'elenco dei requisiti del progetto suddivisi per tipologia. Ciascun requisito possiede un codice identificativo stabilito in accordo con quanto scritto nelle \dext{NormeDiProgetto\_3.0.0}.
...
\begin{center}
    ...
    \begin{longtable}{|p{3cm}|p{9.85cm}|p{2cm}|}
        ...
        %requisiti ivan
        %R1Q1
        \req{1}{Q} & Il prodotto deve essere sviluppato rispettando quanto stabilito nel \dext{PianoDiQualifica\_3.0.0} & Decisione interna \row
        ...
        %requisiti francesco
        %R1Q3
        \req{1}{Q} & Il prodotto deve essere sviluppato rispettando quanto stabilito nelle \dext{NormeDiProgetto\_3.0.0} & Decisione interna \row
