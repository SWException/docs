...
\begin{center}
    ...
    \begin{longtable}{|p{2.5cm}|p{10.35cm}|p{2cm}|}
        ...
        \req{1}{F} & Il cliente autenticato deve poter fare il logout & \refUserCase{UC14}\row
        ...
        \sreq{2}{F} & Il venditore deve poter cercare un cliente presente nel sistema tramite il suo indirizzo email & \refUserCase{UC18.1} \row
        ...
        \sreq{2}{F} & Il venditore deve poter cercare un prodotto presente nel sistema & \refUserCase{UC20.5} \row
        \sreq{2}{F} & Il venditore deve poter filtrare la lista di prodotti del negozio & \refUserCase{UC20.4}  \row
