...
\begin{center}
    ...
    \begin{longtable}{|p{2.5cm}|p{10.35cm}|p{2cm}|}
        ...
        %requisiti ivan
        %1
        \req{1}{F} & Il cliente deve poter visualizzare in HomePage ciò che il sito offre & \refUserCase{UC1} \row
        \sreq{1}{F} & Il cliente deve poter visualizzare le informazione sul venditore & \refUserCase{UC1} \row
        \sreq{1}{F} & Il cliente deve poter visualizzare le informazioni di contatto del venditore & \refUserCase{UC1} \row
        \sreq{1}{F} & Il cliente deve visualizzare i prodotti in vetrina & \refUserCase{UC1} \row %vetrina: messi in evidenza/in promozione
        ...
        %9
        \req{1}{F} & Il cliente autenticato deve avere il carrello sincronizzato tra i suoi dispositivi & \refUserCase{UC7.1} \row
        \sreq{1}{F} & Il cliente che si autentica deve ritrovarsi importato automaticamente il carrello iniziato prima dell'autenticazione & \refUserCase{UC7.1}, decisione interna \row
        %10
        \req{1}{F} & Il cliente deve poter visualizzare il carrello & \refUserCase{UC7.2} \row
        \sreq{1}{F} & Il cliente deve visualizzare tutti i prodotti presenti & \refUserCase{UC7.2} \row
        \sreq{1}{F} & Il cliente deve visualizzare la quantità dei prodotti presenti & \refUserCase{UC7.2} \row
        \sreq{1}{F} & Il cliente deve visualizzare il costo totale del carrello & \refUserCase{UC7.2} \row
        \sreq{1}{F} & Il cliente deve visualizzare il costo dei singoli prodotti presenti & \refUserCase{UC7.2} \row
        \sreq{1}{F} & Il cliente deve visualizzare il costo totale della VAT & \refUserCase{UC7.2}, capitolato \row
        \sreq{2}{F} & Il cliente deve visualizzare un messaggio se il carrello è vuoto & \refUserCase{UC7.2} \row
        %11
        \req{1}{F} & Il cliente deve poter modificare la quantità di un prodotto nel carrello & \refUserCase{UC7.3} \row
        \sreq{1}{F} & Il cliente deve poter aumentare la quantità di un prodotto nel carrello & \refUserCase{UC7.3} \row
        \sreq{1}{F} & Il cliente deve poter diminuire la quantità di un prodotto nel carrello & \refUserCase{UC7.3} \row
        \sreq{1}{F} & Il cliente che aumenta la quantità deve visualizzare un messaggio se la quantità richiesta non è disponibile & \refUserCase{UC7.3} \row
        %12
        \req{1}{F} & Il cliente deve poter eliminare un prodotto dal carrello & \refUserCase{UC7.4} \row
        %13
        \req{1}{F} & Il cliente deve poter eliminare tutti i prodotti dal carrello & \refUserCase{UC7.4} \row
