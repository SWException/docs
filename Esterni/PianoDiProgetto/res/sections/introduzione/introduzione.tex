...
\begin{itemize}
    ...
    \item una \textit{G} a pedice di una parola o un gruppo di parole in \textit{corsivo} indica la presenza del termine all'interno del \dext{Glossario\_4.0.0}.
\end{itemize}
...
\begin{itemize}
    \item \textbf{Norme di progetto}: \dext{NormeDiProgetto\_4.0.0}.
...
\begin{itemize}
    \item \textbf{Piano di qualifica}: \dext{PianoDiQualifica\_4.0.0}.
