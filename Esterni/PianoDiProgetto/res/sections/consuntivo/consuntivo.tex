...
\begin{itemize}
    \item \textbf{Amministratore di Progetto}: le \dext{Norme di Progetto v1.0.0} hanno subito durante questo periodo numerosi aggiornamenti che hanno fatto si che le ore necessarie a ricoprire questo ruolo aumentassero;
    \item \textbf{Analista}: la redazione dell'\dext{Analisi dei Requisiti v1.0.0} ha richiesto più tempo del previsto;
