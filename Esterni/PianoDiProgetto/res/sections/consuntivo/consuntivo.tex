% !TeX root = ../../../main.tex
\section{Consuntivi di periodo} \label{_consultivo}
...
\begin{itemize}
    \item \textbf{Amministratore di Progetto}: le \dext{Norme di Progetto} hanno subito durante questo periodo numerosi aggiornamenti che hanno fatto si che le ore necessarie a ricoprire questo ruolo aumentassero;
    \item \textbf{Analista}: la redazione dell'\dext{Analisi dei Requisiti} ha richiesto più tempo del previsto;
