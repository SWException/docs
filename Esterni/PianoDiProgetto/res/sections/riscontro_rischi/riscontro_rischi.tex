...
\begin{center}
			...
			\textbf{Codice} & \textbf{Periodo} & \textbf{Problema} & \textbf{Mitigazione} & \textbf{Confronto mitigazione adottata/prevista}  \\
			\hline
			\endfirsthead

			\hline
			RST1 & Analisi dei requisiti & Per molti componenti del gruppo le tecnologie e i linguaggi da utilizzare per il progetto sono completamente nuovi. Nello specifico l'utilizzo di \LaTeX ha richiesto ad alcuni componenti uno studio da zero. & Tempo permettendo, è stato assegnato uno studio preliminare delle tecnologie attraverso la documentazione fornita dalle stesse in modo da arrivare all'inizio dello sviluppo con delle basi e dei concetti già chiari. L'inizializzazione dei primi documenti Latex è stata svolta dai componenti con più esperienza in modo da permettere agli altri membri di recuperare il gap. & La mitigazione adottata rispecchia quella prevista\\
			\hline
			RST1 & Progettazione completa e implementazione & Per molti componenti del gruppo le tecnologie e i pattern architetturali da utilizzare per il progetto e il capitolato in questione non erano chiari. Questo deriva principalmente dal fatto che per tutti i componenti è il primo vero progetto collaborativo con l'utilizzo di paradigmi di programmazione all'avanguardia (come i Microservizi). & Per mitigare questo rischio e quindi non dilatare le tempistiche del progetto il gruppo ha richiesto un incontro col proponente per definire le richieste architetturali e successivamente è stato consultato il Prof. Cardin per avere un riscontro diretto sulle scelte implementative fatte. & La mitigazione adottata rispecchia quella prevista \\
			\hline
			RSO1 & Analisi dei requisiti & Alcuni membri del gruppo devono svolgere oltre al progetto di Ingegneria del Software anche altri esami e scadenze in altri corsi. & I compiti sono stati riassegnati per agevolare i membri del gruppo con difficoltà o con più esami da portare in parallelo. & La mitigazione adottata rispecchia quella prevista\\
			\hline
			RSO3 & Analisi dei requisiti & Alcune scadenze durante il periodo di Analisi dei Requisiti sono state stringenti. & Le scadenze successive hanno tenuto conto della mole di lavoro di ogni componente permettendo ad ognuno di avere delle tempistiche adeguate. & La mitigazione adottata rispecchia quella prevista\\
			\hline
