...
% 
\subsection{MPR-6: Requisiti obbligatori soddisfatti (PROS)} \label{_MPR-6}
...
\subsection{MPR-7: Requisiti opzionali non  soddisfatti (RONS )} \label{_MPR-7}
...
\subsection{MPR-8: Requisiti desiderabili non soddisfatti (RDNS)} \label{_MPR-8}
...
\subsection{MPR-9: Rischi non previsti ma avvenuti (RNPA)} \label{_MPR-9}
Indica il numero di rischi non previsti ma che si sono presentanti nel corso del progetto.



% 
\subsection{MPD-S6: Profondità strutturale dell'interfaccia (PSI)}
