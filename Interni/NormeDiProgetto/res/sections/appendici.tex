...
Per misurare la qualità del codice sorgente prodotto vengono adottate le seguenti metriche.

\subsubsection{MPD-ART1: Complessità ciclomatica}
...
\subsubsection{MPD-ART2: Complessità espressioni booleane}
...
\subsubsection{MPD-ART3: Lunghezza delle righe di codice}
...
\subsubsection{MPD-ART4: Code coverage}
