...
\subsubsection{MPR-DOC1: Budgeted Cost of Work Scheduled (BCWS)} \label{_MPR-1}
Rappresenta il costo pianificato in euro per realizzare le attività di progetto alla data corrente.

\subsubsection{MPR-DOC2: Actual Cost of Work Performed (ACWP)} \label{_MPR-2}
Rappresenta il costo effettivamente sostenuto in euro alla data corrente.

\subsubsection{MPR-DOC3: Budgeted Cost of Work Performed (BCWP)} \label{_MPR-3}
Rappresenta il valore in euro delle attività realizzate alla data corrente.

\subsubsection{MPR-DOC4: Cost Variance (CV)} \label{_MPR-4}
...
\subsubsection{MPR-DOC5: Schedule Variance (SV)} \label{_MPR-5}
...
\subsubsection{MPR-DOC6: Requisiti obbligatori soddisfatti (PROS)} \label{_MPR-6}
...
\subsubsection{MPR-DOC7: Requisiti opzionali non  soddisfatti (RONS )} \label{_MPR-7}
...
\subsubsection{MPR-DOC8: Requisiti desiderabili non soddisfatti (RDNS)} \label{_MPR-8}
...
\subsubsection{MPR-DOC9: Rischi non previsti ma avvenuti (RNPA)} \label{_MPR-9}
...
può provocare comportamenti indesiderati e/o imprevisti dell'artefatto. La definizione della soglia minima viene rimandata al \dext{Piano di Qualifica v1.0.0}.
