...
\paragraph{MPR-1: Budgeted Cost of Work Scheduled (BCWS)} \label{_MPR-1}
Rappresenta il costo pianificato in euro per realizzare le attività di progetto alla data corrente.

\paragraph{MPR-2: Actual Cost of Work Performed (ACWP)} \label{_MPR-2}
Rappresenta il costo effettivamente sostenuto in euro alla data corrente.

\paragraph{MPR-3: Budgeted Cost of Work Performed (BCWP)} \label{_MPR-3}
