...
Il gruppo è provvisto di un indirizzo email che verrà utilizzato per comunicazioni esterne, in particolare per comunicazioni verso i committenti. Il controllo della casella di posta elettronica per verificare la presenza di nuove comunicazionei può essere svolto da qualunque membro del gruppo, mentre l'invio di una nuova email è effettuabile soltanto dal Responsabile di progetto.\\
...
\begin{itemize}
    ...
    \item \textbf{creazione issue di esecuzione}: il responsabile crea una issue su GitHub secondo quanto riportato nel capitolo sulla "Gestione dei cambiamenti". Provvede ad inserire nella descrizione la data di scadenza precedentemente stabilità, ed eventualmente una breve descrizione del lavoro da svolgere;
    ...
    \item \textbf{spostamento pull request in "DONE"}: se il verificatore non riscontra correzioni da fare, o quelle effettuate sono sodisfacenti, sposta la pull request in "DONE" ed elimina l'etichetta ad essa applicata;
    \item \textbf{approvazione del lavoro}: il responsabile di progetto dopo aver esaminato il lavoro lo approva effettuando il merge con il ramo interessato. Nel fare ciò dovrà selezionare l'opzione "Squash and marge" ed assegnare un titolo significativo al commit.
\end{itemize}
...
\begin{itemize}
    \item Budgeted Cost of Work Scheduled - BCWS
