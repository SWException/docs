...
A seguito della presentazione dei \glock{capitolati} d'appalto da parte dei proponenti il Responsabile di Progetto organizza riunioni tra i membri del gruppo al fine di condividere internamente opinioni sui capitolati stessi.
...
\paragraph{Metriche} \label{_metricheDoc}
...
\paragraph{Descrizione}
La scrittura del codice dovrà perseguire gli obiettivi di qualità definiti nel \dext{PianoDiQualifica\_4.0.0}.
...
definito nel \dext{PianoDiQualifica\_4.0.0}.
...
può provocare comportamenti indesiderati e/o imprevisti dell'artefatto. La definizione della soglia minima viene rimandata al \dext{PianoDiQualifica\_4.0.0}.
