...
Il codice viene verifiato con test automatici e con misurazioni quantificabili specificate all'interno del \dext{Piano di qualifica}. Il codice quindi deve obbedire a questi criteri:
\begin{itemize}
...
L'analisi dinamica prevede la verifica del codice mirata a rilevare gli errori mentre questo è in fase di esecuzione. Questa fase è caratterizzata dall'esecuzione di una batteria di test per verificare il crretto funzionamento del codice prodotto.\\
