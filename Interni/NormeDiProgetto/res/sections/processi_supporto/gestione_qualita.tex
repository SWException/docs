...
\subsubsection{Scopo}
La finalità è quella di garantire la qualità prestabilita di prodotti e processi da sviluppare, rispettano le richieste del proponente. 
...
\begin{itemize}
    \item organizzare le attività e i processi in modo efficace e prolifico, conseguendo la qualità programmata;
...
\begin{itemize}
    \item il processo che si sta istanziando deve avere un unico obiettivo, il quale non deve sovrapporsi con quelli di altri processi già in sviluppo;
    \item avviare una analisi preventiva dei rischi scrupolosa;
