...
sia essa \verb|MikTex| o \verb|TexLive|, prima di far convergere il proprio ramo in develop. In ogni caso l'azione di push e di merge di una pull request sul ramo develop innesca un workflow di \glock{GitHub Action} denominato \textit{Docs Checker} il cui scopo è quello di compilare il sorgente \LaTeX di tutti i documenti presenti nel ramo develop e restituire l'esito della compilazione senza produrre alcun artefatto. Questo costituisce un ulteriore controllo mirato al mantenimento della qualità del materiale presente nel ramo develop.
