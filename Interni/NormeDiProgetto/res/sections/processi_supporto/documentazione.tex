...
\item\textbf{verifica}: in questa fase vengono assegnati dei \glock{verificatori} che hanno il compito di controllare che il lavoro fatto dai redattori sia coerente con le norme e gli obiettivi riguardanti la tipologia di documento redatto. I verificatori hanno inoltre il compito di riferire ai redattori le eventuali modifiche da apportare. 
...
Il codice identificativo è riportato seguendo la seguente dicitura \textbf{VX_Y.Z}, dove:
\begin{itemize}
	...
	\item\textbf{Y} : indica la data del verbale nel formato YYYY-MM-DD; % i rrr, da cui abbiamo preso il template usavano qui la data e non il numero, sarebbe bene ci uniformassimo
