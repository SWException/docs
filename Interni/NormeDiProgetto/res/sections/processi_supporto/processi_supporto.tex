...
Applicazione open source per costruire \glock{diagrammi di Gantt}, usati largamente nelle attività di pianificazione e presenti nel \textit{PianoDiProgetto\_1.0.0}.
...
\begin{itemize}
    ...
    \item siano coerenti con gli accordi presi con il proponente, riportati all'interno dell'\dext{AnalisiDeiRequisiti\_1.0.0}.
\end{itemize}
...
\subsubsection{Test}
I test costituiscono l'attività fondamentale dell'analisi dinamica: permettono di individuare i bug e di dimostrare che l'applicativo sviluppato è conforme rispetto a tutti i requisiti concordati nell'\dext{AnalisiDeiRequisiti\_1.0.0}.\\
